...
const Update = () => {
  ...
  return (
      <div className='form'>
        ...
        <input type="text" name="name" value={name} onChange={(e)=>setName(e.target.value)} autoComplete="off" className='text-field'/>  <br/>  <br/>
        <label htmlFor="age">Age</label>&nbsp; 
        <input type="number" name="age" value={age} onChange={(e)=>setAge(e.target.value)} autoComplete="off" className='text-field'/>  <br/>  <br/>
        <label htmlFor="course">Course</label>&nbsp; 
        <input type="text" name="course" value={course} onChange={(e)=>setCourse(e.target.value)} autoComplete="off" className='text-field'/>  <br/>  <br/>
        <label htmlFor="batch">Batch</label>&nbsp; 
        <input type="text" name="batch" value={batch} onChange={(e)=>setBatch(e.target.value)} autoComplete="off" className='text-field'/><br/>  <br/>
